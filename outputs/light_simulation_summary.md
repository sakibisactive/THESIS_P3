# Midtown Manhattan Map Light Simulation Report

This report summarizes details and trip statistics on the **Midtown Manhattan** map (`data/networks/midtown_manhattan.net.xml`).

## 1. Map Structural Specifications
* **Map Centerline Road Distance:** **132.420 km** (132420.47 meters)
* **Map Total Lane Distance:** **271.316 km** (271316.47 meters)
